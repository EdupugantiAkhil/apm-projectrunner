# APM ProjectRunner Tab Route extension

This unpacked Chromium Manifest V3 extension connects the active tab to one declared
APM ProjectRunner route. It has no build step and no third-party dependencies.
...
4. Pin **APM ProjectRunner Tab Route**, open a UI tab, and choose one route.
