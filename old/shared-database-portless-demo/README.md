# Archived: shared database, duplicated service

This is the original Portless-based proof-of-concept and is not the current Switchyard
architecture. It remains runnable for historical comparison. It implements
[`features.md`](features.md) and runs three
containers:

The current project architecture is documented in [`../../DESIGN.md`](../../DESIGN.md).
