...
fn current_example_deployments_remain_schema_compatible_and_deterministic() {
    ...
    let goldens = [
        Golden {
            ...
            definition_hash: "2f6582f5129eca45791d01bf8112091d5c573a89164e2f64f11c886dacd10e87",
            resource_hash: "7c009e69b9fc121976e5332828cbae2024a6b0eb91dd336af1e352caa426e74d",
            route_configs: 12,
        ...
        Golden {
            ...
            deployment: "jas-base",
            definition_hash: "bbdfec1bb9ace137ea53a00bc92ca0fdf1e75cbc556b9bd40226aa6a31865618",
            resource_hash: "996072685626bbd590f02bf4cc7d6b6817a5c3abca4e0cf3ab4226bf26e51ebb",
            route_configs: 6,
            has_host_router: true,
        },
    ];
