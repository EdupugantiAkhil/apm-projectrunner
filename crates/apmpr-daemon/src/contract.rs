...
use apmpr_state::DeploymentReconciliation;
...
pub enum RunActionDefinitionV1 {
    Structured {
        command: apmpr_run_actions::StructuredCommand,
...
pub struct DeploymentValidationV1 {
    ...
    pub name: String,
    pub valid: bool,
    pub diagnostics: Vec<apmpr_planner::Diagnostic>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub warnings: Vec<apmpr_planner::PlannerWarning>,
    pub preview: Value,
}
...
pub struct DeploymentDetailV1 {
    ...
    pub resources: Vec<apmpr_state::OwnedResourceObservation>,
    pub custom_domains: Vec<String>,
    #[serde(default)]
    pub custom_domain_links: Vec<CustomDomainLinkV1>,
    pub memberships: Value,
...
/// Whether APM ProjectRunner can execute containers on a device.
#[derive(Clone, Copy, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "kebab-case")]
...
pub struct DeviceV1 {
    ...
    pub last_check_status: apmpr_state::DeviceCheckStatus,
...
pub type SourceV1 = apmpr_sources::RegisteredSourceInspection;

/// Live worktree inspection entry.
pub type WorktreeV1 = apmpr_sources::WorktreeInspection;
