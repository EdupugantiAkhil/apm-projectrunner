...
use apmpr_planner::{OverlayOptions, load_bundle, plan, plan_with_overlays};
...
fn vision_sample_validates_and_plans_without_compatibility_router_fields() {
    ...
    let bundle = apmpr_planner::load_bundle_from_str(&yaml, &deployment_path)
...
fn generated_gateway_skips_a_browser_listener_on_its_preferred_port() {
    let yaml = vision_sample_without_deferred_scripts();
    let deployment_path = repository_path("docs/vision/vision-sample-deployment.yaml");
    let initial = apmpr_planner::load_bundle_from_str(&yaml, &deployment_path).unwrap();
    ...
    let colliding = apmpr_planner::load_bundle_from_str(&colliding_yaml, &deployment_path).unwrap();
...
fn legacy_workspace_fixture_expands_through_generic_planner_contracts() {
    ...
    let expected = BTreeSet::from([
        "jas-base--ai-feature--namespace",
        "jas-base--ai-feature--router",
        "jas-base--ai-feature--suite--app",
        "jas-base--ai-main--namespace",
        "jas-base--ai-main--router",
        "jas-base--ai-main--suite--app",
        "jas-base--db-main--document-store",
        "jas-base--db-main--initialize-schema",
        "jas-base--db-main--kv-store",
        "jas-base--fixture-image--builder",
        "jas-base--jas-feature--namespace",
        "jas-base--jas-feature--router",
        "jas-base--jas-feature--service--app",
        "jas-base--jas-main--namespace",
        "jas-base--jas-main--router",
        "jas-base--jas-main--service--app",
        "jas-base--ui-a--namespace",
        "jas-base--ui-a--router",
        "jas-base--ui-a--app--app",
        "jas-base--ui-b--namespace",
        "jas-base--ui-b--router",
