...
fn usage() -> &'static str {
    "usage:\n  apmpr-router [sidecar] <config.json> <admin.socket>\n  apmpr-router host <config.json> <admin.socket>\n  apmpr-router admin-client <admin.socket>\n  apmpr-router certificates trust|cleanup <config.json>"
}
