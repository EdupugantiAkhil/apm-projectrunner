//! Shared remote-device eligibility checks and presentation semantics.
...
use apmpr_state::{DeviceCheckStatus, RegisteredDevice};
...
mod tests {
    ...
    fn checks_ssh_then_docker_with_native_ssh_transport() {
        ...
        assert_eq!(
            calls[1].2[OsStr::new("APMPR_DOCKER_SSH_IDENTITY")],
            "keys/id_ed25519"
        );
