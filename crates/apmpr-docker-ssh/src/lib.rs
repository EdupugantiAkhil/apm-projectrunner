...
const REAL_SSH_ENV: &str = "APMPR_DOCKER_REAL_SSH";
const IDENTITY_ENV: &str = "APMPR_DOCKER_SSH_IDENTITY";
const LAUNCHER: &[u8] = b"#!/bin/sh\nexec \"$APMPR_DOCKER_REAL_SSH\" -o BatchMode=yes -o IdentitiesOnly=yes -i \"$APMPR_DOCKER_SSH_IDENTITY\" \"$@\"\n";
