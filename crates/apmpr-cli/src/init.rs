...
const FILES: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!("../templates/init/.agents/skills/apmpr-project/SKILL.md"),
    ),
    (
        ".agents/skills/apmpr-project/agents/openai.yaml",
        include_str!("../templates/init/.agents/skills/apmpr-project/agents/openai.yaml"),
    ),
];
...
/// Collect the minimum project details required for `apmpr init` when no
