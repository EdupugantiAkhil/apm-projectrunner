//! Framework-neutral contracts, registry, and conformance helpers for APM ProjectRunner adapters.
//!
...
pub const SDK_CONTRACT_VERSION: &str = "apmpr.dev/adapter-sdk/v1alpha1";
...
mod tests {
    ...
    fn compatibility_failures_have_stable_registry_codes() {
        let declaration = AdapterDeclaration {
            id: "example".into(),
            version: "1.0.0".into(),
            sdk_contracts: vec!["apmpr.dev/adapter-sdk/v2".into()],
