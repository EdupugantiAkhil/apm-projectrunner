//! Full-screen terminal control plane for an APM ProjectRunner project.
...
const REOPEN_ENV: &str = "APMPR_TUI_REOPEN_CODE";
const NOTICE_ENV: &str = "APMPR_TUI_CODE_NOTICE";
